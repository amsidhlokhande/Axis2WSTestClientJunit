...
public class ConverterTest extends junit.framework.TestCase {
	...
	public void testfarenheitToCelsius() throws java.lang.Exception {
		...
		wtp.ConverterStub.FarenheitToCelsius farenheitToCelsius8 = (wtp.ConverterStub.FarenheitToCelsius) getTestObject(wtp.ConverterStub.FarenheitToCelsius.class);
	...
	public void testStartfarenheitToCelsius() throws java.lang.Exception {
		...
		stub.startfarenheitToCelsius(farenheitToCelsius8,
	...
	public void testcelsiusToFarenheit() throws java.lang.Exception {
		...
		wtp.ConverterStub.CelsiusToFarenheit celsiusToFarenheit10 = (wtp.ConverterStub.CelsiusToFarenheit) getTestObject(wtp.ConverterStub.CelsiusToFarenheit.class);
	...
	public void testStartcelsiusToFarenheit() throws java.lang.Exception {
		...
		stub.startcelsiusToFarenheit(celsiusToFarenheit10,
